...
lbl = Label(window, text="Threshold: " + str(threshold), font=("Arial Bold", 25))
lbl.grid(column=0, row=0)
var =IntVar()
var.set(threshold)
spin = Spinbox(window, from_=0, to=100, width=5, textvariable=var, font=("Arial Bold", 25))
spin.grid(column=0,row=1)
lbl2 = Label(window, text="Last Triggered: ", font=("Arial Bold", 15))
...
def print_sound(indata, frames, time, status):
    ...
    if int(volume_norm) > threshold:
        ...
        lbl2.configure(text="Last Triggered: " + dt_string)        
